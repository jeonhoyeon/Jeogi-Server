package com.howabout.there.popularcourse.dto;
...
public class PopularCourseDto {
	...
	public String toString() {
		return "testDto [r_name=" + r_name + ", r_phone=" + r_phone + ", r_lon=" + r_lon + ", r_lat=" + r_lat
				...
				+ ", r_id=" + r_id + ", r_url=" + r_url + ", r_image_url=" + r_image_url + ", c_name=" + c_name
				+ ", c_phone=" + c_phone + ", c_lon=" + c_lon + ", c_lat=" + c_lat + ", c_do=" + c_do + ", c_si=" + c_si
				+ ", c_gu=" + c_gu + ", c_dong=" + c_dong + ", c_cat=" + c_cat + ", c_id=" + c_id + ", c_url=" + c_url
